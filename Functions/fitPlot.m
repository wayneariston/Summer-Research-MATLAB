...
%     pl = plot( fitresult, [xData, yData], zData, 'Style', 'PredObs', 'Level', 0.99);
    ...
    axis equal tight
    shading interp
    patch([z z l-z l-z], [z z z z], [meanz-rangez meanz+rangez meanz+rangez meanz-rangez],...
        [0 0 0 0],'HandleVisibility','off','FaceColor','red','FaceAlpha',0.3);
    patch([z z z z], [z z h-z h-z], [meanz-rangez meanz+rangez meanz+rangez meanz-rangez],...
        [0 0 0 0],'HandleVisibility','off','FaceColor','red','FaceAlpha',0.3);
    patch([z z l-z l-z], [h-z h-z h-z h-z], [meanz-rangez meanz+rangez meanz+rangez meanz-rangez],...
        [0 0 0 0],'HandleVisibility','off','FaceColor','red','FaceAlpha',0.3);
    patch([l-z l-z l-z l-z], [z z h-z h-z], [meanz-rangez meanz+rangez meanz+rangez meanz-rangez],...
        [0 0 0 0],'HandleVisibility','off','FaceColor','red','FaceAlpha',0.3);
    view( -3.5, 16.7 );
